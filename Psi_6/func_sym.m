...
%--------------------------要改-----------------------------
psi_ck_known_sym = Ups_ck1 * cos(omega_n * xc) + Ups_ck2 * sin(omega_n * xc)...
    + Ups_ck3;
psi_bk_known_sym = sym(0);
psi_ck_uncertain_sym = [xc + Gamma_k1, xc^2 + Gamma_k2, 0, 0, 0, 0];
psi_bk_uncertain_sym = [0, 0, cos(alpha_bk * xb), sin(alpha_bk * xb), xb, 1];
%--------------------------要改-----------------------------
