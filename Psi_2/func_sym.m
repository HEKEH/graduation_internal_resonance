...
psi_ck_known_sym = Ups_ck1 * xc * cos(omega_n * xc) + Ups_ck2 * xc * sin(omega_n * xc)...
    + Ups_ck3 * cos(omega_m * xc) + Ups_ck4 * sin(omega_m * xc) + Ups_ck5;
psi_bk_known_sym = Ups_bk1 * xb * cos(alpha_bk * xb) + Ups_bk2 * xb * sin(alpha_bk * xb) + Ups_bk3 * xb * cosh(beta_bk * xb) + Ups_bk4 * xb * sinh(beta_bk * xb);
psi_ck_uncertain_sym = [cos(omega_n * xc) + Gamma_k1, sin(omega_n * xc) + Gamma_k2, 0, 0, 0, 0];
